        ...
        <div class="w-full md:w-3/4">
            <div class="mb-6 flex justify-between items-center">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <button type="button" id="grid-view" class="p-1.5 rounded-md bg-white dark:bg-github-secondary border border-gray-300 dark:border-github-border text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-github-accent hover:border-primary-600 dark:hover:border-github-accent transition-colors duration-200">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                        </svg>
                    </button>
                    <button type="button" id="list-view" class="p-1.5 rounded-md bg-primary-50 dark:bg-github-hover border border-primary-600 dark:border-github-accent text-primary-600 dark:text-github-accent transition-colors duration-200">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (gridView && listView && documentsGrid) {
                    ...
                    function applyGridView() {
                        ...
                        gridView.classList.remove('bg-white', 'dark:bg-github-secondary', 'text-gray-500', 'dark:text-gray-400');
                        gridView.classList.add('bg-primary-50', 'dark:bg-github-hover', 'text-primary-600', 'dark:text-github-accent');
                        
                        listView.classList.remove('bg-primary-50', 'dark:bg-github-hover', 'text-primary-600', 'dark:text-github-accent');
                        listView.classList.add('bg-white', 'dark:bg-github-secondary', 'text-gray-500', 'dark:text-gray-400');
                        ...
                        listView.classList.add('border-gray-300', 'dark:border-github-border');
                    ...
                    function applyListView() {
                        ...
                        listView.classList.remove('bg-white', 'dark:bg-github-secondary', 'text-gray-500', 'dark:text-gray-400');
                        listView.classList.add('bg-primary-50', 'dark:bg-github-hover', 'text-primary-600', 'dark:text-github-accent');
                        
                        gridView.classList.remove('bg-primary-50', 'dark:bg-github-hover', 'text-primary-600', 'dark:text-github-accent');
                        gridView.classList.add('bg-white', 'dark:bg-github-secondary', 'text-gray-500', 'dark:text-gray-400');
                        ...
                        gridView.classList.add('border-gray-300', 'dark:border-github-border');
