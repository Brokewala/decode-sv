    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-white dark:bg-github-secondary rounded-lg shadow-md dark:shadow-lg border border-gray-200 dark:border-github-border overflow-hidden">
            ...
            <div class="p-6 border-b border-gray-200 dark:border-github-border">
                <div class="flex items-start">
                    <div class="flex-shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-primary-600 dark:text-github-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                            Déposez vos formats de documents pour gagner des points. Les documents Word et Excel vous rapportent <span class="font-medium text-primary-600 dark:text-github-accent">2 points</span>, tandis que les PDF vous rapportent <span class="font-medium text-primary-600 dark:text-github-accent">1 point</span>.
                        </p>
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            ...
            <form action="{{ route('documents.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-1" x-data="{ fileName: '' }">
                        <div class="flex items-center justify-center w-full">
                            <label class="flex flex-col w-full h-32 border-2 border-dashed rounded-md border-gray-300 dark:border-github-border cursor-pointer hover:bg-gray-50 dark:hover:bg-github-bg/50" x-on:dragover.prevent x-on:drop="
                            ...
                            ">
                                ...
                                <div class="flex flex-col items-center justify-center pt-7" x-show="fileName">
                                    <p class="text-sm font-medium text-primary-600 dark:text-github-accent" x-text="fileName"></p>
                ...
                <!-- Prix en points -->
                <div class="bg-gray-50 dark:bg-github-bg rounded-md p-4">
                    <h3 class="font-medium text-gray-700 dark:text-gray-300">Points que vous allez gagner :</h3>
                    <div class="mt-2">
                        <div class="inline-flex items-center bg-primary-100 dark:bg-primary-900/20 px-3 py-1.5 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-primary-600 dark:text-github-accent mr-1.5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div>
                    <div class="flex items-start mb-4">
                        <div class="flex-shrink-0">
                            <input id="terms" name="terms" type="checkbox" required
                                   class="h-4 w-4 rounded border-gray-300 dark:border-github-border text-primary-600 dark:text-github-accent focus:ring-primary-500 dark:focus:ring-github-accent dark:bg-github-bg">
                        </div>
                        <div class="ml-3">
                    ...
                    <button type="submit" class="w-full flex justify-center items-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-primary-600 dark:bg-github-button hover:bg-primary-700 dark:hover:bg-github-buttonHover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 dark:focus:ring-github-accent dark:focus:ring-offset-github-bg">
