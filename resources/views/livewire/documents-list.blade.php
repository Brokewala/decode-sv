                ...
                <div class="p-5 flex justify-between items-center">
                    <div>
                        ...
                        <div class="flex items-center mt-1">
                            ...
                            <span class="ml-1 text-2xl font-bold text-gray-900 dark:text-white">{{ $userPoints }}</span>
                        </div>
                    </div>
        ...
        <div class="w-full md:w-3/4">
            <div class="mb-6 flex justify-between items-center">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <button type="button" wire:click="setViewMode('grid')" class="p-1.5 rounded-md {{ $viewMode === 'grid' ? 'bg-primary-50 dark:bg-dark-surface border-primary-600 dark:border-github-accent text-primary-600 dark:text-dark-accent' : 'bg-white dark:bg-dark-surface border border-gray-300 dark:border-dark-border text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-dark-accent hover:border-primary-600 dark:hover:border-dark-accent transition-colors duration-200' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                        </svg>
                    </button>
                    <button type="button" wire:click="setViewMode('list')" class="p-1.5 rounded-md {{ $viewMode === 'list' ? 'bg-primary-50 dark:bg-dark-surface border-primary-600 dark:border-github-accent text-primary-600 dark:text-dark-accent' : 'bg-white dark:bg-dark-surface border border-gray-300 dark:border-dark-border text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-dark-accent hover:border-primary-600 dark:hover:border-dark-accent transition-colors duration-200' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <!-- Documents -->
            <div class="grid grid-cols-1 {{ $viewMode === 'grid' ? 'sm:grid-cols-2 lg:grid-cols-3' : '' }} gap-6" wire:loading.class.delay="opacity-50 pointer-events-none">
                ...
                @empty
                    <div class="col-span-full">
                        <div class="bg-white dark:bg-dark-surface rounded-lg shadow-md dark:shadow-lg border border-gray-200 dark:border-dark-border p-8 text-center">
                            ...
                            <button wire:click="resetFilters" class="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-primary-600 dark:bg-dark-button hover:bg-primary-700 dark:hover:bg-dark-buttonHover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 dark:focus:ring-dark-accent dark:focus:ring-offset-dark-bg">
