        ...
        <div class="w-full mb-6 md:w-1/4 md:mb-0">
            <div class="overflow-hidden bg-white border border-gray-200 rounded-lg shadow-md dark:bg-dark-surface dark:shadow-lg dark:border-dark-border">
                <div class="p-5 border-b border-gray-200 dark:border-dark-border">
                    <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-white">Filtres</h2>
                </div>
                ...
                <div class="p-5">
                    <div class="space-y-4">
                        <!-- Recherche -->
                        <div class="mb-4">
                            <label for="search" class="block mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">Recherche</label>
                            <div class="relative">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                <input type="number" wire:model.debounce.300ms="priceMin"
                                       placeholder="Min"
                                       min="0" step="1"
                                       class="w-full border-gray-300 rounded-md shadow-sm dark:border-dark-border focus:border-primary-500 dark:focus:border-dark-accent focus:ring-primary-500 dark:focus:ring-dark-accent dark:bg-dark-bg dark:text-white sm:text-sm">
                                <input type="number" wire:model.debounce.300ms="priceMax"
                                       placeholder="Max"
                                       min="0" step="1"
                                       class="w-full border-gray-300 rounded-md shadow-sm dark:border-dark-border focus:border-primary-500 dark:focus:border-dark-accent focus:ring-primary-500 dark:focus:ring-dark-accent dark:bg-dark-bg dark:text-white sm:text-sm">
                            </div>
            ...
            <div class="grid grid-cols-1 gap-4 mb-6 sm:grid-cols-3">
                ...
                <div class="p-4 bg-white border border-gray-200 rounded-lg dark:bg-dark-surface dark:border-dark-border">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Résultats filtrés</p>
                ...
                <div class="p-4 bg-white border border-gray-200 rounded-lg dark:bg-dark-surface dark:border-dark-border">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Pays disponibles</p>
                ...
                <p class="text-gray-700 dark:text-gray-300">
                    ...
                    @if($search || $country || $format || $priceMin || $priceMax || $dateFrom || $dateTo)
                        <span class="ml-2 text-sm text-gray-500 dark:text-gray-400">
                            (filtré sur {{ number_format($totalDocuments) }} total)
                        </span>
                    @endif
                </p>
                <div class="flex items-center space-x-2">
                    <span class="text-sm text-gray-700 dark:text-gray-300">Affichage:</span>
                    <button type="button" wire:click="$set('viewMode', 'grid')" class="p-1.5 rounded-md {{ $viewMode === 'grid' ? 'bg-primary-50 dark:bg-dark-surface border-primary-600 dark:border-github-accent text-primary-600 dark:text-dark-accent' : 'bg-white dark:bg-dark-surface border border-gray-300 dark:border-dark-border text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-dark-accent hover:border-primary-600 dark:hover:border-dark-accent transition-colors duration-200' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                        </svg>
                    </button>
                    <button type="button" wire:click="$set('viewMode', 'list')" class="p-1.5 rounded-md {{ $viewMode === 'list' ? 'bg-primary-50 dark:bg-dark-surface border-primary-600 dark:border-github-accent text-primary-600 dark:text-dark-accent' : 'bg-white dark:bg-dark-surface border border-gray-300 dark:border-dark-border text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-dark-accent hover:border-primary-600 dark:hover:border-dark-accent transition-colors duration-200' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                @empty
                    <div class="col-span-full">
                        <div class="p-8 text-center bg-white border border-gray-200 rounded-lg shadow-md dark:bg-dark-surface dark:shadow-lg dark:border-dark-border">
                            ...
                            <h3 class="mb-2 text-lg font-medium text-gray-900 dark:text-white">Aucun document trouvé</h3>
                            <p class="mb-6 text-gray-500 dark:text-gray-400">Aucun document ne correspond à vos critères de recherche.</p>
                            <button wire:click="resetFilters" class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white border border-transparent rounded-md shadow-sm bg-primary-600 dark:bg-dark-button hover:bg-primary-700 dark:hover:bg-dark-buttonHover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 dark:focus:ring-dark-accent dark:focus:ring-offset-dark-bg">
