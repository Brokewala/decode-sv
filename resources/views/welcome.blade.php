        ...
        <div class="bg-gradient-to-br from-primary-600 to-primary-700 dark:from-github-accent dark:to-github-hover rounded-lg shadow-md dark:shadow-lg p-8 text-white transform transition-transform duration-300 hover:scale-[1.01]">
            <div class="text-center max-w-2xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row justify-center space-y-3 sm:space-y-0 sm:space-x-4">
                    <a href="{{ route('register') }}" class="bg-white hover:bg-gray-100 text-primary-700 dark:text-github-bg px-6 py-3 rounded-md font-medium transition-colors duration-200 shadow-lg hover:shadow-xl">
                        S'inscrire gratuitement
                    </a>
                    <a href="{{ route('documents.index') }}" class="bg-primary-700/30 hover:bg-primary-700/50 dark:bg-dark-bg/20 dark:hover:bg-dark-bg/30 text-white px-6 py-3 border border-primary-500/30 dark:border-dark-accent/30 rounded-md font-medium transition-colors duration-200 shadow-lg hover:shadow-xl">
