<x-app-layout>
    ...
    <section class="mb-16 animate-fade-in">
        <div class="bg-white dark:bg-github-secondary rounded-lg shadow-md dark:shadow-lg border border-gray-200 dark:border-github-border overflow-hidden hover:shadow-lg transition-shadow duration-300">
            <div class="px-6 py-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="rounded-lg border border-gray-200 dark:border-github-border bg-gray-50 dark:bg-github-bg p-6 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md">
    ...
    <section class="mb-16 animate-fade-in" style="animation-delay: 0.2s;">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('documents.index') }}" class="text-primary-600 dark:text-github-accent hover:text-primary-700 dark:hover:text-github-hover flex items-center group">
                Voir tout
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            @forelse ($latestDocuments as $document)
                <div class="bg-white dark:bg-github-secondary rounded-lg shadow-md dark:shadow-lg border border-gray-200 dark:border-github-border overflow-hidden transition duration-300 hover:shadow-lg dark:hover:border-github-accent/30 hover:-translate-y-1">
                    ...
                    <div class="p-4">
                        ...
                        <a href="{{ route('documents.show', $document) }}" 
                           class="mt-3 w-full inline-flex justify-center items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-primary-600 dark:bg-github-button hover:bg-primary-700 dark:hover:bg-github-buttonHover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 dark:focus:ring-github-accent dark:focus:ring-offset-github-bg transition-colors duration-300">
            ...
            @empty
                <div class="col-span-full">
                    <div class="bg-white dark:bg-github-secondary rounded-lg shadow-md dark:shadow-lg border border-gray-200 dark:border-github-border p-8 text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 mx-auto text-gray-400 dark:text-gray-500 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">Aucun document disponible</h3>
                        <p class="text-gray-500 dark:text-gray-400 mb-6">Soyez le premier à partager un document !</p>
                        <a href="{{ route('documents.create') }}" class="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-primary-600 dark:bg-github-button hover:bg-primary-700 dark:hover:bg-github-buttonHover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 dark:focus:ring-github-accent dark:focus:ring-offset-github-bg">
                            Déposer un document
                        </a>
                    </div>
                </div>
    ...
    <section class="animate-fade-in" style="animation-delay: 0.4s;">
        <div class="bg-gradient-to-br from-primary-600 to-primary-700 dark:from-github-accent dark:to-github-hover rounded-lg shadow-md dark:shadow-lg p-8 text-white transform transition-transform duration-300 hover:scale-[1.01]">
            <div class="text-center max-w-2xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row justify-center space-y-3 sm:space-y-0 sm:space-x-4">
                    <a href="{{ route('register') }}" class="bg-white hover:bg-gray-100 text-primary-700 dark:text-github-bg px-6 py-3 rounded-md font-medium transition-all duration-200 shadow-lg hover:shadow-xl">
                        S'inscrire gratuitement
                    </a>
                    <a href="{{ route('documents.index') }}" class="bg-primary-700/30 hover:bg-primary-700/50 dark:bg-github-bg/20 dark:hover:bg-github-bg/30 text-white px-6 py-3 border border-primary-500/30 dark:border-github-accent/30 rounded-md font-medium transition-all duration-200 shadow-lg hover:shadow-xl">
