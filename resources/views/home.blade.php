<x-app-layout>
    ...
    <section class="mb-16 animate-fade-in">
        <div class="bg-white dark:bg-dark-surface rounded-lg shadow-md dark:shadow-lg border border-gray-200 dark:border-dark-border overflow-hidden hover:shadow-lg transition-shadow duration-300">
            <div class="px-6 py-8">
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 mr-2 text-primary-600 dark:text-dark-accent" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="rounded-lg border border-gray-200 dark:border-dark-border bg-gray-50 dark:bg-dark-bg p-6 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md">
                        <div class="bg-primary-100 dark:bg-dark-surface rounded-full p-3 inline-flex items-center justify-center mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-primary-600 dark:text-dark-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section class="mb-16 animate-fade-in" style="animation-delay: 0.2s;">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 mr-2 text-primary-600 dark:text-dark-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                Derniers formats ajoutés
            </h2>
            <a href="{{ route('documents.index') }}" class="text-primary-600 dark:text-dark-accent hover:text-primary-700 dark:hover:text-dark-accentHover flex items-center group">
                Voir tout
        ...
        <div class="bg-gradient-to-br from-primary-600 to-primary-700 dark:from-github-accent dark:to-github-hover rounded-lg shadow-md dark:shadow-lg p-8 text-white transform transition-transform duration-300 hover:scale-[1.01]">
            <div class="text-center max-w-2xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row justify-center space-y-3 sm:space-y-0 sm:space-x-4">
                    ...
                    <a href="{{ route('documents.index') }}" class="bg-primary-700/30 hover:bg-primary-700/50 dark:bg-dark-bg/20 dark:hover:bg-dark-bg/30 text-white px-6 py-3 border border-primary-500/30 dark:border-dark-accent/30 rounded-md font-medium transition-all duration-200 shadow-lg hover:shadow-xl">
