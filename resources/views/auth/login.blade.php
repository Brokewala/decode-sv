                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('login.post') }}" class="space-y-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-sm">
                                <a href="#" class="font-medium text-primary-600 dark:text-dark-accent hover:text-primary-500 dark:hover:text-dark-accentHover">
                                    Mot de passe oublié ?
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mt-6">
                            <p class="text-center text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <a href="{{ route('register') }}" class="font-medium text-primary-600 dark:text-dark-accent hover:text-primary-500 dark:hover:text-dark-accentHover">
