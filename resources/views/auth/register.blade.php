                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                <label for="terms" class="text-sm text-gray-700 dark:text-gray-300">
                                    J'accepte les <a href="#" class="text-primary-600 dark:text-github-accent hover:text-primary-500 dark:hover:text-github-hover">conditions d'utilisation</a> et la <a href="#" class="text-primary-600 dark:text-github-accent hover:text-primary-500 dark:hover:text-github-hover">politique de confidentialité</a>.
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mt-6">
                            <p class="text-center text-sm text-gray-600 dark:text-gray-400">
                                Déjà inscrit ?
                                <a href="{{ route('login') }}" class="font-medium text-primary-600 dark:text-github-accent hover:text-primary-500 dark:hover:text-github-hover">
                                    Connectez-vous
                                </a>
                            </p>
                        </div>
