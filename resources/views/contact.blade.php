                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <textarea id="message" name="message" rows="6" required
                                      class="block w-full border-gray-300 rounded-md shadow-sm dark:border-dark-border focus:border-primary-500 dark:focus:border-dark-accent focus:ring-primary-500 dark:focus:ring-dark-accent dark:bg-dark-bg dark:text-white sm:text-sm"></textarea>
                        </div>
                    </div>
            ...
            <div class="p-6 space-y-4">
                <div class="flex items-start">
                    <div class="flex-shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-primary-600 dark:text-dark-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
